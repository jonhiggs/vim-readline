...
" delete-char-or-list () Deletes the character under the cursor if not at the
" beginning or end of the line (like delete-char). If at the end of the line,
" behaves identically to possible-completions. This command is unbound by
" default.<Paste>

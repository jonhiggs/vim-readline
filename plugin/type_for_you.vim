...
" http://www.delorie.com/gnu/docs/readline/rlman_19.html
...
" match in turn. At the end of the list of completions, the bell is rung (subject
" to the setting of bell-style) and the original text is restored. An argument of
" n moves n positions forward in the list of matches; a negative argument may be
" used to move backward through the list. This command is intended to be bound to
...
" possible-completions. This command is unbound by default.<Paste>
